...
Example:
    python src/scripts/seed_carrier_modules.py https://openinsure-backend.braveriver-f92a9f28.swedencentral.azurecontainerapps.io
"""
...
BASE_URL = (
    sys.argv[1]
    if len(sys.argv) > 1
    else "https://openinsure-backend.braveriver-f92a9f28.swedencentral.azurecontainerapps.io"
)
