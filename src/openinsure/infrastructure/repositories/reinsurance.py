"""In-memory reinsurance repositories for local development and testing."""
...
class InMemoryReinsuranceRepository(BaseRepository):
    """Dict-backed reinsurance store for local development and testing."""
