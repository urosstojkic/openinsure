"""In-memory cession and recovery repositories for reinsurance module."""
...
class InMemoryCessionRepository(BaseRepository):
    """Dict-backed cession store for local development and testing."""
...
class InMemoryRecoveryRepository(BaseRepository):
    """Dict-backed recovery store for local development and testing."""
