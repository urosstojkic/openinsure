"""In-memory MGA authority and bordereau repositories."""
...
class InMemoryMGAAuthorityRepository(BaseRepository):
    """Dict-backed MGA authority store for local development."""

    def __init__(self) -> None:
        self._store: dict[str, dict[str, Any]] = {}

    async def create(self, entity: dict[str, Any]) -> dict[str, Any]:
        key = entity.get("mga_id") or entity.get("id", "")
...
class InMemoryMGABordereauRepository(BaseRepository):
    """Dict-backed MGA bordereau store for local development."""
