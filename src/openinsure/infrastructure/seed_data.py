    ...
    return [
        {
            ...
            "coverages": [
                ...
                },
                {
                    ...
                    "description": "Coverage for ransomware payments and extortion response.",
                    "default_limit": 500_000.0,
                    "max_limit": 2_000_000.0,
                    "default_deductible": 10_000.0,
                    "is_optional": True,
            ...
            "rating_factor_tables": [
                {
                    "name": "industry",
                    "description": "Industry risk multiplier",
                    "entries": [
                        {"key": "technology", "multiplier": 0.85, "description": "Lower cyber risk profile"},
                        {"key": "financial_services", "multiplier": 1.20, "description": "Higher data exposure"},
                        {"key": "healthcare", "multiplier": 1.40, "description": "PHI and regulatory risk"},
                        {"key": "retail", "multiplier": 1.15, "description": "PCI exposure"},
                        {"key": "manufacturing", "multiplier": 1.30, "description": "OT/IT convergence risk"},
                    ],
                },
                {
                    "name": "revenue_band",
                    "description": "Revenue-based size factor",
                    "entries": [
                        {"key": "under_1m", "multiplier": 0.80, "description": "< $1M revenue"},
                        {"key": "1m_5m", "multiplier": 0.90, "description": "$1M–$5M"},
                        {"key": "5m_15m", "multiplier": 1.00, "description": "$5M–$15M"},
                        {"key": "15m_30m", "multiplier": 1.10, "description": "$15M–$30M"},
                        {"key": "30m_50m", "multiplier": 1.25, "description": "$30M–$50M"},
                    ],
                },
                {
                    "name": "security_posture",
                    "description": "Security maturity discount/surcharge",
                    "entries": [
                        {"key": "excellent", "multiplier": 0.70, "description": "Score 9–10"},
                        {"key": "good", "multiplier": 0.85, "description": "Score 7–8"},
                        {"key": "average", "multiplier": 1.00, "description": "Score 5–6"},
                        {"key": "below_average", "multiplier": 1.25, "description": "Score 3–4"},
                        {"key": "poor", "multiplier": 1.60, "description": "Score 1–2"},
                    ],
                },
            ],
            ...
            "authority_limits": {
                ...
                "max_auto_bind_limit": 2_000_000.0,
                "requires_senior_review_above": 50_000.0,
                "requires_cuo_review_above": 100_000.0,
            },
        ...
        },
        {
            ...
            "rating_factor_tables": [
                {
                    "name": "industry",
                    "description": "Professional services sector multiplier",
                    "entries": [
                        {"key": "legal", "multiplier": 1.30, "description": "Higher E&O exposure"},
                        {"key": "accounting", "multiplier": 1.20, "description": "Financial advisory risk"},
                        {"key": "consulting", "multiplier": 1.00, "description": "Standard risk"},
                        {"key": "engineering", "multiplier": 1.15, "description": "Design liability exposure"},
                    ],
                },
            ],
            ...
            "authority_limits": {
                ...
                "max_auto_bind_limit": 5_000_000.0,
                "requires_senior_review_above": 75_000.0,
                "requires_cuo_review_above": 150_000.0,
            },
            "territories": ["US", "CA"],
            "effective_date": _days_ago(120),
            "expiration_date": _days_from_now(245),
            "forms": ["ACORD 130", "Professional Liability Supplement"],
            "version_history": [],
            "metadata": {},
            "created_at": _days_ago(120),
            "updated_at": _days_ago(30),
        },
        {
            ...
            "authority_limits": {
                ...
                "max_auto_bind_limit": 5_000_000.0,
                "requires_senior_review_above": 40_000.0,
                "requires_cuo_review_above": 100_000.0,
            },
            "territories": ["US"],
            "effective_date": _days_ago(90),
        ...
        },
        {
            ...
            "rating_factor_tables": [
                {
                    "name": "tech_segment",
                    "description": "Technology sub-sector multiplier",
                    "entries": [
                        {"key": "saas", "multiplier": 0.90, "description": "SaaS platforms"},
                        {"key": "fintech", "multiplier": 1.20, "description": "Financial technology"},
                        {"key": "healthtech", "multiplier": 1.35, "description": "Health-tech regulated data"},
                        {"key": "ecommerce", "multiplier": 1.10, "description": "E-commerce platforms"},
                    ],
                },
            ],
            ...
            "authority_limits": {
                ...
                "max_auto_bind_limit": 3_000_000.0,
                "requires_senior_review_above": 50_000.0,
                "requires_cuo_review_above": 100_000.0,
            },
            ...
            "forms": ["ACORD 130", "Technology E&O Supplement"],
            "version_history": [],
            "metadata": {},
            "created_at": _days_ago(90),
            "updated_at": _days_ago(15),
