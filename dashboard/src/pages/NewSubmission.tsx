  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        applicant_email: form.contactEmail || undefined,
        line_of_business: form.lob,
        ...
        ...(form.lob === 'cyber' && {
          cyber_risk_data: {
            security_maturity_score: form.securityMaturity,
            has_mfa: form.hasMfa,
            has_endpoint_protection: form.hasEndpointProtection,
            has_backup_strategy: form.hasBackupStrategy,
            has_incident_response_plan: form.hasIncidentResponsePlan,
