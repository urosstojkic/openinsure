            ...
            <tbody className="divide-y divide-slate-50">
              {queue.map((item) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 font-mono text-xs text-slate-500 max-w-[100px] truncate" title={item.policy_id}>{item.policy_number || (item.policy_id ? item.policy_id.substring(0, 8) + '…' : '—')}</td>
                  ...
                  <td className="px-3 py-2 text-xs text-slate-600">{formatDate(item.loss_date)}</td>
